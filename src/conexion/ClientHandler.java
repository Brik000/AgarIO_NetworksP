...
public class ClientHandler implements Runnable{
	...
	ArrayList<Pair<String, String>> playersInfo;

	public ClientHandler(Socket socket,ArrayList<Pair<String, String>> playersInfo,String c)
	{
		this.socket =  socket;
			...
			if(headerLine!=null)
			{
				...
				if(httpMethod.equals("GET"))
				{
					...
					if(httpQueryString.equals("/"))
					{
						...
						String str="";
						BufferedReader buf = new BufferedReader(new FileReader("docs/web/login.html"));
